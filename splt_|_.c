...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/03/29 22:15:04 by sdiouane          #+#    #+#             */
/*   Updated: 2024/03/29 22:26:32 by sdiouane         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// 			if (args[i + 1])
// 			{
// 				char *temp1 = ft_strjoin(redirection, " ");
// 				redirection = ft_strjoin(temp1[i], args[i]);
// 				i++;
